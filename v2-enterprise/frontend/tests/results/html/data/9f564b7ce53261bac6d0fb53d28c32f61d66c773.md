...
- Name: receipt-print-qa-datasets.spec.ts >> dataset A: exactly one A5 page, no clipped content, receipt renders
...
Call log:
  - navigating to "http://localhost:3412/showroom/print-test-fixture?mode=single&dataset=A", waiting until "networkidle"
