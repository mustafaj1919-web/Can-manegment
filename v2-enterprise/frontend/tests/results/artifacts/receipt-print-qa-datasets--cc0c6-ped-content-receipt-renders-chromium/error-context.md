...
- Name: receipt-print-qa-datasets.spec.ts >> dataset C: exactly one A5 page, no clipped content, receipt renders
...
Call log:
  - navigating to "http://localhost:3412/showroom/print-test-fixture?mode=single&dataset=C", waiting until "networkidle"
