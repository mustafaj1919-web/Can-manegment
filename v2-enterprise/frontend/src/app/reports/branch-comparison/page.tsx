    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="section-subtitle">تحليلات الأداء المالي بين الفروع</p>
          </div>
        </div>
        <Button variant="glass" size="sm" disabled className="h-8 gap-2 cursor-not-allowed">
      ...
      <div className="glass rounded-xl py-20 text-center border border-border/30 max-w-xl mx-auto">
        ...
        <p className="mt-2 text-xs text-muted-foreground max-w-sm mx-auto leading-relaxed">
          نحن نعمل على توفير تقرير مقارنة الفروع وتحليلات الأداء المالي بين الفروع المختلفة في التحديثات القادمة لربطه مباشرة بنقاط نهاية الباكيند الحقيقية.
        </p>
      </div>
    </div>
  )
