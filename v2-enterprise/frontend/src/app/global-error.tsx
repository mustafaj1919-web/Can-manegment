  ...
  return (
    <html lang="ar" dir="rtl">
      <body style={{ margin: 0, background: '#0d0d0d', color: '#f1f5f9', fontFamily: 'Tajawal, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', flexDirection: 'column', gap: '16px', textAlign: 'center' }}>
        ...
        <button
          onClick={reset}
          style={{ marginTop: '8px', padding: '10px 24px', background: '#10B981', color: '#fff', fontWeight: 'bold', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: 'pointer', fontFamily: 'inherit' }}
        >
          إعادة تحميل
        </button>
        {error.digest && (
