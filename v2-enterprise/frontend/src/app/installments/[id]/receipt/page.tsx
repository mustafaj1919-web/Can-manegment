    ...
    <div dir="rtl" className="min-h-screen bg-white text-black">
      ...
      <div className="mx-auto max-w-md px-8 py-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-muted-foreground text-sm">شركة الأصدقاء لتجارة السيارات</p>
        </div>

        {/* Receipt number + date */}
        <div className="bg-slate-50 rounded-lg p-4 mb-4 flex items-center justify-between text-sm">
          <div>
            <p className="text-muted-foreground text-xs">رقم السند</p>
        ...
        <div className="border border-slate-200 rounded-lg p-4 mb-4 text-sm space-y-2">
          {schedule && (
            <div className="flex justify-between">
              <span className="text-muted-foreground">القسط رقم:</span>
        ...
        <div className="bg-slate-800 text-white rounded-lg p-5 mb-4 text-center">
          <p className="text-muted-foreground text-xs mb-1">المبلغ المستلم</p>
          <p className="text-3xl font-black">{formatMoney(payment.amount, payment.currency as 'USD' | 'IQD')}</p>
        </div>

        {/* Plan summary */}
        {planInfo && (
          <div className="border border-slate-200 rounded-lg p-4 text-xs text-muted-foreground space-y-1.5">
            <p className="font-semibold text-muted-foreground mb-2">ملخص خطة الأقساط</p>
            <div className="flex justify-between">
