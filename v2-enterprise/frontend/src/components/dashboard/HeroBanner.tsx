...
export function HeroBanner() {
  ...
  return (
    <motion.section
      ...
      className="revauto-hero overflow-hidden relative rounded-xl border border-border/50"
      style={{
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 sm:p-8 lg:p-10 items-center min-h-[520px]">
        ...
        <div className="lg:col-span-12 flex flex-wrap items-center justify-between gap-3 border-b border-border/40 pb-4">
        ...
        <div className="lg:col-span-6 space-y-5">
          ...
          <p className="text-[13px] text-muted-foreground max-w-lg leading-relaxed font-family-cairo">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <Link href="/inventory" className="inline-flex items-center gap-2 px-6 py-3 border border-white/15 hover:border-white/35 text-white/90 font-semibold text-sm rounded-lg transition-all bg-secondary/30 hover:bg-secondary/50 active:scale-95 font-family-cairo">
              استكشف المعرض
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-border/50">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground font-family-cairo mt-0.5">ثقة، أمان وسرعة في إتمام المعاملات</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-12 border-t border-border/50 pt-5">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 items-center">
            <div className="space-y-0.5">
              <span className="text-[10px] uppercase tracking-widest text-muted-foreground block font-bold font-family-cairo">إجمالي المبيعات</span>
              <div className="text-2xl font-black text-red-500 font-numeric tracking-tight flex items-baseline gap-1.5">
                ...
                <small className="text-[11px] text-muted-foreground font-semibold">د.ع</small>
              </div>
            </div>
            <div className="space-y-0.5">
              <span className="text-[10px] uppercase tracking-widest text-muted-foreground block font-bold font-family-cairo">السيارات المتاحة</span>
              <div className="text-2xl font-black text-white font-numeric tracking-tight flex items-baseline gap-1.5">
                ...
                <small className="text-[11px] text-muted-foreground font-semibold">سيارة</small>
              </div>
            </div>
            <div className="space-y-0.5">
              <span className="text-[10px] uppercase tracking-widest text-muted-foreground block font-bold font-family-cairo">الصفقات المكتملة</span>
              <div className="text-2xl font-black text-white font-numeric tracking-tight flex items-baseline gap-1.5">
                <AnimatedCounter value={stats?.sales ?? 0} />
                <small className="text-[11px] text-muted-foreground font-semibold">بيعة</small>
              </div>
            </div>
            <div className="flex justify-end gap-2">
              <Link href="/reports" className="flex h-10 w-10 items-center justify-center rounded-lg border border-border/50 bg-secondary/30 hover:bg-red-600 hover:border-red-600 text-white transition-all active:scale-95" title="فتح التقارير">
