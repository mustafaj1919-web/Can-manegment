    ...
    <span className={cn(
      ...
      flat
        ...
        : up
          ...
          : 'text-rose-600 dark:text-rose-400 border-rose-500/25 bg-rose-500/10',
    )}>
  ...
  return (
    <div className="border border-border/50 rounded-2xl overflow-hidden bg-card shadow-xs">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-border/50 bg-card">
        <div>
          <p className="text-sm font-bold text-foreground">مؤشر الإيرادات والأرباح السنوي</p>
          <p className="text-[11px] text-muted-foreground mt-0.5">آخر 12 شهراً — بالمليون دينار</p>
        </div>
        {last && prev && (
