  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* ── Sticky action bar ── */}
        <div className="sticky bottom-0 z-10 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 mt-8 flex items-center justify-end gap-3 border-t border-border/40 bg-black/60 py-4 backdrop-blur-md shadow-[0_-12px_40px_rgba(0,0,0,0.6)]">
          <Button 
            type="button" 
            variant="ghost" 
            onClick={() => router.back()} 
            disabled={mutation.isPending}
            className="hover:bg-secondary/30 text-muted-foreground hover:text-foreground transition-all duration-200"
          >
            إلغاء
          </Button>
          <Button 
