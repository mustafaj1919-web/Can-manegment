      ...
      <DropdownMenu>
        ...
        >
          <DropdownMenuLabel className="font-normal px-3 py-2.5">
            <div className="flex items-center gap-2.5">
              <Avatar className="h-8 w-8 ring-1 ring-white/[0.1]">
                <AvatarFallback className="bg-gradient-to-br from-primary to-red-950 text-white text-[11px] font-bold">
                  {getInitials(displayUser.username)}
                </AvatarFallback>
              </Avatar>
          ...
          <DropdownMenuItem
            ...
            className="gap-2.5 text-foreground/70 focus:text-slate-100 focus:bg-secondary/40 rounded-lg px-3 py-2.5 cursor-pointer"
          >
        ...
        <DialogContent dir="rtl" className="max-w-sm">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <Button type="submit" disabled={saving} className="gap-2 bg-primary text-white hover:bg-primary/90">
