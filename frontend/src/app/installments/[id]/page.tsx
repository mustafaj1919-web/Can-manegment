...
const STATUS_META: Record<string, { icon: React.ElementType; color: string; bg: string }> = {
  ...
  Pending: { icon: Clock,         color: 'text-muted-foreground', bg: 'bg-white/5' },
        ...
        <div className="glass rounded-xl p-5">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={label} className="rounded-xl bg-white/[0.03] border border-white/[0.05] py-3">
          ...
          <div className="glass rounded-xl p-5">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
              {[
                ...
                <div key={item.label} className="rounded-xl border border-white/[0.05] bg-white/[0.03] p-3 text-center">
