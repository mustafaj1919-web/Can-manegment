...
import { Wallet, RefreshCw, AlertCircle, Download } from 'lucide-react'
    ...
    <div className="space-y-5" dir="rtl">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="section-title">حركة الصندوق</h1>
      ...
      <div className="glass rounded-xl p-4 flex flex-wrap gap-3 items-end">
        <div>
          <label className="text-[11px] text-muted-foreground mb-1 block">الصندوق</label>
          <Select value={accountCode} onValueChange={setAccountCode}>
            <SelectTrigger className="h-9 w-[200px] bg-white/5 border-white/10 text-sm"><SelectValue /></SelectTrigger>
            <SelectContent>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="dash-card p-4 text-center">
            ...
            <p className={cn(
              ...
              data.final_balance >= 0 ? 'text-foreground' : 'text-rose-400'
            )}>{formatMoney(data.final_balance, 'IQD')}</p>
          </div>
        </div>
      )}
      ...
      <div className="glass overflow-hidden rounded-xl">
        {isLoading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">تعذر تحميل حركة الصندوق</p>
          </div>
