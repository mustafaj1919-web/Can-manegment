...
const STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  ...
  draft:    { label: 'مسودة',  cls: 'bg-slate-500/10  text-slate-400  border-slate-500/20'  },
    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="glass overflow-hidden rounded-lg">
        {isLoading ? (
          ...
          <>
            {/* Table header */}
            <div className="hidden sm:grid grid-cols-[90px_100px_80px_1fr_90px_100px_100px_60px] border-b border-white/[0.06] bg-white/[0.02] px-4 py-2.5">
            ...
            {items.map((entry, i) => {
              ...
              return (
                <motion.div key={entry.id}
                  ...
                  <div
                    className="grid grid-cols-[1fr_auto] sm:grid-cols-[90px_100px_80px_1fr_90px_100px_100px_60px] items-center gap-2 px-4 py-3 hover:bg-white/[0.02] cursor-pointer"
                  ...
                  <AnimatePresence initial={false}>
                    {expanded.has(entry.id) && (
                      ...
                      >
                        <div className="bg-white/[0.015] border-t border-white/[0.04] px-6 pb-3 pt-2">
                          ...
                          {entry.lines.map((line, li) => (
                            <div key={li} className="grid grid-cols-[120px_1fr_100px_100px] items-center py-1 px-1 rounded hover:bg-white/[0.03] text-xs">
