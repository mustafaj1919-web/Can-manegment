  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="border-t border-white/[0.06] px-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[100, 500, 1000, 5000].map(usd => (
                <div key={usd} className="flex items-center justify-between rounded-lg bg-white/[0.03] border border-white/[0.05] px-3 py-2">
      ...
      <div className="glass rounded-xl overflow-hidden">
        ...
        <div className="p-5">
          {/* Mode toggle */}
          <div className="flex rounded-xl bg-white/[0.03] p-1 mb-5 gap-1">
            {([
              ...
              >
                <div>
                  ...
                  <Input
                    ...
                    className="bg-white/5 border-white/10 money text-lg h-12 text-center"
                  />
