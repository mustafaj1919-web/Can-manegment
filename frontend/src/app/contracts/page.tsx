    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="glass rounded-xl p-4 flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input
            ...
            className="ps-9 h-9 bg-white/5 border-white/10 text-sm"
          />
        </div>
      ...
      <div className="glass overflow-hidden rounded-xl">
        {isLoading ? (
          ...
          <>
            {/* Header */}
            <div className="hidden lg:grid grid-cols-[110px_90px_140px_120px_90px_80px_80px_60px_80px_70px_50px] border-b border-white/[0.06] bg-white/[0.02] px-4 py-2.5 gap-2">
            ...
            {data!.items.map((c: ContractItem) => (
              <div
                key={c.sale_id}
                className="border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] px-4 py-3"
              >
