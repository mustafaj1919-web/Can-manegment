        ...
        <Section title="معلومات الحساب">
          <div className="sm:col-span-2">
            ...
            <Input
              ...
              className={cn('bg-white/5 border-white/10 h-9', errors.username && 'border-rose-500/50')}
            />
          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className={cn('bg-white/5 border-white/10 h-9 pe-9', errors.password && 'border-rose-500/50')}
              />
            ...
            {password && (
              <div className="mt-1.5 space-y-1">
                <div className="flex gap-0.5">
                  {[1,2,3,4].map(i => (
                    <div key={i} className={cn('h-1 flex-1 rounded-full transition-all', pwStrength.score >= i ? pwStrength.color : 'bg-white/10')} />
                  ))}
                </div>
          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className={cn('bg-white/5 border-white/10 h-9', errors.confirm && 'border-rose-500/50')}
              />
        ...
        <Section title="الدور والصلاحيات">
          <div>
            ...
            <select
              ...
              className={cn(
                'w-full h-9 rounded-md border border-white/10 bg-white/5 px-3 text-sm text-foreground',
            ...
            <>
              <div>
                ...
                <select
                  ...
                  disabled={grantAll}
                  className="w-full h-9 rounded-md border border-white/10 bg-white/5 px-3 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-violet-500/40 disabled:opacity-40"
                >
