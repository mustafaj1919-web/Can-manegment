...
const SEGMENTS = [
  ...
  { key: 'sold_cars',      label: 'مباعة',   color: '#6C3FFF', glow: 'text-violet-400'  },
  { key: 'reserved_cars',  label: 'محجوزة', color: '#F59E0B', glow: 'text-amber-400'   },
] as const
            ...
            <div className="space-y-2 mt-2">
              {segments.map((s, i) => (
                <motion.div
                  ...
                  className="flex items-center justify-between rounded-lg bg-white/[0.03] border border-white/[0.04] px-3.5 py-2.5"
                >
