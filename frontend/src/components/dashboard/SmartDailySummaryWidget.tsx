...
function KpiChip({ icon: Icon, label, value, tone }: { icon: React.ElementType; label: string; value: string; tone: string }) {
  return (
  ...
  return (
    <div className="dash-card overflow-hidden" dir="rtl">
      ...
      <div className="flex items-center gap-3 border-b border-white/[0.06] px-5 py-3.5">
        ...
        <div>
          <h2 className="text-sm font-bold text-foreground">الملخص الذكي اليومي</h2>
