...
const BUCKETS = [
  { key:'overdue',  label:'متأخرة',    countKey:'overdue_count',       amtKey:'overdue_amount',       color:'#cc2118', text:'text-red-400',    bg:'bg-red-500/8',    border:'border-red-500/15'    },
  { key:'today',    label:'اليوم',      countKey:'due_today_count',     amtKey:'due_today_amount',     color:'#f59e0b', text:'text-amber-400',  bg:'bg-amber-500/8',  border:'border-amber-500/15'  },
  ...
  { key:'two_days', label:'بعد يومين', countKey:'due_in_2_days_count', amtKey:'due_in_2_days_amount', color:'#3b82f6', text:'text-blue-400',   bg:'bg-blue-500/8',   border:'border-blue-500/15'   },
] as const
          ...
          {pieData.length > 0 && (
            <div className="relative h-36 mb-4">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={pieData} cx="50%" cy="50%" innerRadius={44} outerRadius={62} paddingAngle={3} dataKey="value" strokeWidth={0}>
