...
export function PrintableContract({
  ...
  return (
    <div className="min-h-screen bg-[#07111f] px-4 py-6 text-foreground print:bg-white print:px-0 print:py-0" dir="rtl">
      ...
      <article className="contract-page mx-auto max-w-5xl rounded-lg border border-white/10 bg-white p-8 text-slate-950 shadow-2xl print:m-0 print:max-w-none print:rounded-none print:border-0 print:p-0 print:shadow-none">
        ...
        <section className="mt-10 grid grid-cols-3 gap-5 text-center">
          {['البائع', 'المشتري', 'منظم العقد'].map((label) => (
            <div key={label} className="pt-10">
              ...
              <p className="mt-1 text-xs text-slate-500">الاسم والتوقيع</p>
            </div>
          ))}
        </section>
      </article>
